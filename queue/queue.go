...
type Queue interface {
	...
	// Cout return the output item channel
	//
	Cout() <-chan Item
...
func New(initialCapacity int, chOut bool) Queue {
	sq := &byteQueue{
		initCap: initialCapacity,
		chOut:   chOut,
		cout:    make(chan Item, chCount),
...
// Output channel
func (q *byteQueue) Cout() <-chan Item {
	return q.cout
}
